...
Watchdog detects a failed container and recovers it automatically, no manual intervention.

![Container stopped and self-healed](docs/images/service-stopped-n-healed.png)

### Real-Time Telegram Alerts
Instant notifications on container failures and successful recoveries.

![Telegram notifications](docs/images/telegram-notifications.png)

### AI-Powered Incident Analysis
Periodic incident summaries generated by an LLM (Groq), analyzing patterns across the incident log.

![AI incident analysis via Telegram](docs/images/telegram-notification-analyzer.png)

### Watchdog Service — Activation & Logs
Watchdog running as a systemd service with structured logging.

![Watchdog systemd activation and logs](docs/images/watchdog-activation-n-logs.png)

### Infrastructure as Code — Ansible Playbooks
Full stack (hardening, Docker, monitoring, edge node) deployed and validated via Ansible across all 3 nodes.

![Ansible playbook run on Ubuntu Server and HP](docs/images/ansible-playbook-debian-ubuntu.png)
![Ansible playbook run on Toshiba Edge Node](docs/images/ansible-playbook-debian-toshiba.png)

### CI/CD Pipeline
Automated security scanning (Trivy) and linting (Ansible + Python) on every push.

![All CI/CD checks passing](docs/images/ci-cd-passing.png)
